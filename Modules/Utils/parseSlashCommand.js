                        ...
                        if (option.Name && option.Description) {
                            ...
                            if (option.Type && optionTypes.includes(option.Type.toLowerCase())) {
                                if (["sub command", 1].includes(option.Type.toLowerCase())) {
                                    optionData.type = 1;
                                } else if (["sub command group", 2].includes(option.Type.toLowerCase())) {
                                    optionData.type = 2;
                                } else if (["string", 3].includes(option.Type.toLowerCase())) {
                                    optionData.type = 3;
                                } else if (["integer", 4].includes(option.Type.toLowerCase())) {
                                    optionData.type = 4;
                                } else if (["boolean", 5].includes(option.Type.toLowerCase())) {
                                    optionData.type = 5;
                                } else if (["user", 6].includes(option.Type.toLowerCase())) {
                                    optionData.type = 6;
                                } else if (["channel", 7].includes(option.Type.toLowerCase())) {
                                    optionData.type = 7;
                                } else if (["role", 8].includes(option.Type.toLowerCase())) {
                                    optionData.type = 8;
                                } else if (["mentionable", 9].includes(option.Type.toLowerCase())) {
                                    optionData.type = 9;
                                }
                            } else {
                            ...
                            if (optionData.type == 1) {
                                ...
                                if (option.ChannelTypes && Array.isArray(option.ChannelTypes) && ["channel", 7].includes(option.Type.toLowerCase())) option.ChannelTypes.forEach((channelType) => {
